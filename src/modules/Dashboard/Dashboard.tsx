...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const fetchUserData = async () => {
      try {
        const response = await axios.get('https://upskilling-egypt.com:3003/api/v1/Users/count', {
          headers: { 'Authorization': `Bearer ${token}` }
        });
    ...
    <>
      <div className="">
        ...
        >
          ...
          <p className="text-lg p-3">You can add projects and assign tasks to your team</p>
        </div>
</div>
        {/* Main Content */}
